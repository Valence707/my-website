...
class App extends React.Component {
  ...
  updateGame() {
    ...
    let board = [...this.state.board];
    let applePos = [...this.state.applePos]; // Update snake head

    sHead[0] += sVel[0];
    sHead[1] += sVel[1]; // Check if snake is touching border or itself.

    if (sHead[0] < 0 || sHead[0] >= board.length || sHead[1] < 0 || sHead[1] >= board[0].length || sBody.filter(item => {
      return item[0] === sHead[0] && item[1] === sHead[1];
    }).length) {
      this.gameOver();
      return;
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", {
      className: "app"
    }, /*#__PURE__*/React.createElement("h1", null, "Snake"), /*#__PURE__*/React.createElement("div", {
      className: "status-display"
    }, /*#__PURE__*/React.createElement("h3", null, "Score: ", this.state.score), /*#__PURE__*/React.createElement("h3", null, "Time: ", this.state.time)), /*#__PURE__*/React.createElement(Board, {
      board: this.state.board,
      gameOver: this.state.gameOver,
      score: this.state.score,
      time: this.state.time,
      gameRun: this.state.gameRunner,
      results: this.state.results[this.state.results.length - 1]
    }));
  }
...
function Board(props) {
  return /*#__PURE__*/React.createElement("svg", null, !props.gameRun && /*#__PURE__*/React.createElement("text", {
    ...
    x: "175",
    y: "280"
  }, "Press 'space' to start the game."), props.board.map((row, rowCount) => {
    return row.map((item, colCount) => {
      if (item != '') {
        return /*#__PURE__*/React.createElement(Square, {
          pos: [rowCount, colCount],
          type: item == 's' ? "green" : item == 'a' ? 'red' : 'black',
          key: rowCount * row.length + colCount
        });
      }
    });
  }), props.gameOver && /*#__PURE__*/React.createElement("text", {
    x: "175",
    y: "150",
    className: "game-over-text"
  }, "Game Over!", /*#__PURE__*/React.createElement("tspan", {
    x: "175",
    y: "200"
  }, "Score: ", props.results.score), /*#__PURE__*/React.createElement("tspan", {
    x: "175",
    y: "230"
  }, "Time elapsed: ", props.results.time)));
}
